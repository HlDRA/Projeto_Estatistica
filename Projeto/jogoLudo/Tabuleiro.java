...
public class Tabuleiro {
    ...
    public void relatorio(){
        for (int i = 0; i < 52; i++){
            if (i > 8) System.out.print(this.mapa[i] + "  ");
            else System.out.print(this.mapa[i] + " ");
        }
        System.out.println();
        for (int i = 0; i < 52; i++){
            System.out.print(i + " ");
        ...
        System.out.print("\n\nAzul: ");
        for (int i = 0; i < 4; i++) System.out.print(this.azul.getPecas()[i] + " ");
        System.out.print("\nvermelho: ");
        for (int i = 0; i < 4; i++) System.out.print(this.vermelho.getPecas()[i] + " ");
        System.out.print("\nverde: ");
        for (int i = 0; i < 4; i++) System.out.print(this.verde.getPecas()[i] + " ");
        System.out.print("\namarelo: ");
        for (int i = 0; i < 4; i++) System.out.print(this.amarelo.getPecas()[i] + " ");
    }
    ...
    public void jogadaAzul(){
        ...
        boolean sair = false;
        if (!this.existeJogadaValida(1,dado) && this.alguemnabase(1) && dado != 6) sair = true;
        else if (!this.existeJogadaValida(1,dado) && this.noOneInBase(1)) sair = true;

        while (!sair){
            jogada = random.nextInt(5);
            if (jogada < 4) atual = this.azul.getPecas()[jogada];
            if (jogada < 4)resultado = dado + this.azul.getPecas()[jogada];

            if (resultado < 52) inimigo = this.mapa[resultado];
            if (inimigo == 1){
                while (inimigo == 1){
            ...
            if (jogada == 4 && dado == 6 && !this.noOneInBase(1)){
                ...
                if (inimigo != 0 && inimigo != 9) {
                    ...
                    if (this.mapa[atual] != 9) this.mapa[atual] = 0;
    ...
    public void jogadaVermelho(){
        ...
        boolean sair = false;
        if (!this.existeJogadaValida(2,dado) && this.alguemnabase(2) && dado != 6) sair = true;
        else if (!this.existeJogadaValida(2,dado) && this.noOneInBase(2)) sair = true;

        while (!sair){
            jogada = random.nextInt(5);
            if (jogada < 4) atual = this.vermelho.getPecas()[jogada];
            if (jogada < 4)resultado = dado + this.vermelho.getPecas()[jogada];
            if (resultado >= 52 && resultado < 95) resultado = resultado - 52;
    ...
    public void jogadaVerde(){
        ...
        boolean sair = false;
        if (!this.existeJogadaValida(3,dado) && this.alguemnabase(3) && dado != 6) sair = true;
        else if (!this.existeJogadaValida(3,dado) && this.noOneInBase(3)) sair = true;

        while (!sair){
            jogada = random.nextInt(5);
            if (jogada < 4) atual = this.verde.getPecas()[jogada];
            if (jogada < 4)resultado = dado + this.verde.getPecas()[jogada];
            if (resultado >= 52 && resultado < 95) resultado = resultado - 52;
    ...
    public void jogadaAmarelo(){
        ...
        boolean sair = false;
        if (!this.existeJogadaValida(4,dado) && this.alguemnabase(4) && dado != 6) sair = true;
        else if (!this.existeJogadaValida(4,dado) && this.noOneInBase(4)) sair = true;

        while (!sair){
            jogada = random.nextInt(5);
            if (jogada < 4) atual = this.amarelo.getPecas()[jogada];
            if (jogada < 4)resultado = dado + this.amarelo.getPecas()[jogada];
            if (resultado >= 52 && resultado < 95) resultado = resultado - 52;
    ...
    public int existeVencedor(){
        if (this.azul.getPecas()[0] == 100 && this.azul.getPecas()[1] == 100 && this.azul.getPecas()[2] == 100
                && this.azul.getPecas()[3] == 100) return 1;
        else if (this.vermelho.getPecas()[0] == 100 && this.vermelho.getPecas()[1] == 100 && this.vermelho.getPecas()[2] == 100
                && this.vermelho.getPecas()[3] == 100) return 2;
        else if (this.verde.getPecas()[0] == 100 && this.verde.getPecas()[1] == 100 && this.verde.getPecas()[2] == 100
                    && this.verde.getPecas()[3] == 100) return 3;
        else if (this.amarelo.getPecas()[0] == 100 && this.amarelo.getPecas()[1] == 100 && this.amarelo.getPecas()[2] == 100
                && this.amarelo.getPecas()[3] == 100) return 4;
        else return 0;
        ...
        switch (time){
            case 1:
                if ((this.azul.getPecas()[0] + dado > 100 || this.azul.getPecas()[0] == -1)
                        ...
                        && (this.azul.getPecas()[3] + dado > 100 || this.azul.getPecas()[3] == -1)) return false;
                break;
            case 2:
                if ((this.vermelho.getPecas()[0] + dado > 100 || this.vermelho.getPecas()[0] == -1)
                        ...
                        && (this.vermelho.getPecas()[3] + dado > 100 || this.vermelho.getPecas()[3] == -1)) return false;
                break;
            case 3:
                if ((this.verde.getPecas()[0] + dado > 100 || this.verde.getPecas()[0] == -1)
                        ...
                        && (this.verde.getPecas()[3] + dado > 100 || this.verde.getPecas()[3] == -1)) return false;
                break;
            case 4:
                if ((this.amarelo.getPecas()[0] + dado > 100 || this.amarelo.getPecas()[0] == -1)
                        ...
                        && (this.amarelo.getPecas()[3] + dado > 100 || this.amarelo.getPecas()[3] == -1)) return false;
                break;
        }
        return true;
    }
        ...
        switch (time){
            case 1:
                if (this.azul.getPecas()[0] != -1 && this.azul.getPecas()[1] != -1
                        && this.azul.getPecas()[2] != -1 && this.azul.getPecas()[3] != -1) return true;
                else return false;
            case 2:
                if (this.vermelho.getPecas()[0] != -1 && this.vermelho.getPecas()[1] != -1 && this.vermelho.getPecas()[2] != -1
                        && this.vermelho.getPecas()[3] != -1) return true;
                else return false;
            case 3:
                if (this.verde.getPecas()[0] != -1 && this.verde.getPecas()[1] != -1 && this.verde.getPecas()[2] != -1
                        && this.verde.getPecas()[3] != -1) return true;
                else return false;
            case 4:
                if (this.amarelo.getPecas()[0] != -1 && this.amarelo.getPecas()[1] != -1 && this.amarelo.getPecas()[2] != -1
                        && this.amarelo.getPecas()[3] != -1) return true;
                else return false;
            default:
                return false;
        }
        ...
        switch (time){
            ...
            case 2:
                if (this.vermelho.getPecas()[0] == -1 || this.vermelho.getPecas()[1] == -1
                        || this.vermelho.getPecas()[2] == -1 || this.vermelho.getPecas()[3] == -1) return true;
                else return false;
            case 3:
                if (this.verde.getPecas()[0] == -1 || this.verde.getPecas()[1] == -1
                        || this.verde.getPecas()[2] == -1 || this.verde.getPecas()[3] == -1) return true;
                else return false;
            case 4:
                if (this.amarelo.getPecas()[0] == -1 || this.amarelo.getPecas()[1] == -1
                        || this.amarelo.getPecas()[2] == -1 || this.amarelo.getPecas()[3] == -1) return true;
                else return false;
            default:
                return false;
        }
    ...
    public Jogador returnJogador (int jogador) {
        if (jogador == 1) return this.azul;
        else if (jogador == 2) return this.vermelho;
        else if (jogador == 3) return this.verde;
        else if (jogador == 4) return this.amarelo;
        else return null;
    }
    ...
    public int buscarJogador(int time, int posicao){
        int resultado = 0;
        for (int i = 0; i < 4; i++) {
            if (time == 1 && this.azul.getPecas()[i] == posicao) return i;
            else if (time == 2 && this.vermelho.getPecas()[i] == posicao) return i;
            else if (time == 3 && this.verde.getPecas()[i] == posicao) return i;
            else if (time == 4 && this.amarelo.getPecas()[i] == posicao) return i;
        }
    ...
    public static void main(String[] args) {
        ...
        while (vitorias < 10000) {
            ...
            if (tabuleiro.existeVencedor() != 0) {
                if (tabuleiro.existeVencedor() == 1) azulVitorias++;
                else if (tabuleiro.existeVencedor() == 2) vermelhoVitorias++;
                else if (tabuleiro.existeVencedor() == 3) verdeVitorias++;
                else if (tabuleiro.existeVencedor() == 4) amareloVitorias++;
                vitorias++;
                tabuleiro.relatorio();
